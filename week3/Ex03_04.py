...
print('한국어 표기법')
print('제1장 표기의 기본 원칙')
print('제1항 한국어는 국어의 현용 24 자모 만으로 적는다.')
print('제2항 한국어의 1 음운은 원칙적으로 1 기호로 적는다.')
print("제3항 받침에는 'ㄱ, ㄴ, ㄹ, ㅁ, ㅂ, ㅅ, ㅇ'만을 쓴다.")
print("제4항 파열음 표기에는 된소리를 쓰지 않는 것을 원칙으로 한다.")
print("제5항 이미 굳어진 한국어는 관용을 존중하되, 그 범위와 용례는 따로 정한다.")
